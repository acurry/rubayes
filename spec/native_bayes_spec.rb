...
describe NativeBayes do
  context "when constructed should have" do
    ...
    it "@words, a hash" do
      @nb.words.should be_an_instance_of Hash
    end
    
    it "@total_words, an integer" do
      @nb.total_words.should be_an_instance_of Fixnum
      @nb.total_words.should eq 0
    end
    
    it "@categories_document, a hash" do
      @nb.categories_documents.should be_an_instance_of Hash
    end
    
    it "@total_documents, an integer" do
      @nb.total_documents.should be_an_instance_of Fixnum
      @nb.total_documents.should eq 0
    end
    
    it "@categories_words, a hash" do
      @nb.categories_words.should be_an_instance_of Hash
    end
    
    it "@threshold, a float" do
      @nb.threshold.should be_an_instance_of Float
      @nb.threshold.should eq 1.5
    end
  end
